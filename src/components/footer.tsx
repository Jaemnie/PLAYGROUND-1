...
export function Footer() {
  return (
    <footer className="w-full backdrop-blur-sm border-t border-zinc-800/50">
      <div className="mx-auto w-full max-w-container px-4 sm:px-6 lg:px-8">
        <div className="py-6">
          <svg className="mx-auto h-4 w-auto text-zinc-400" aria-hidden="true" viewBox="0 0 160 24" fill="none">
            <path
          ...
          <p className="mt-3 text-center text-sm leading-6 text-zinc-400">
            © {new Date().getFullYear()} Tailwind Labs Inc. All rights reserved.
          </p>
